...
export default function PostCard(props: PostProps) {
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="group relative flex w-full max-w-[544px] cursor-pointer flex-col rounded-md border border-gray-200 border-opacity-60 bg-gray-50 p-4 dark:border-gray-900 dark:bg-gray-950"
    >

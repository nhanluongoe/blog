...
export default function PostCard(props: PostProps) {
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="group relative flex w-full cursor-pointer flex-col rounded-md border border-gray-200 border-opacity-60 bg-gray-50 p-3 transition-transform hover:scale-105 dark:border-gray-800 dark:bg-gray-950"
    >
